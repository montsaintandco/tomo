...
const C = {
  ko: {
    ...
    lead: "TOMO는 한국과 일본의 중고마켓을 한 곳에서 보고, 한 번 결제로 집까지 받는 서비스예요. 메루카리·야후 플리마·당근·중고나라 상품을 내 언어, 내 통화로 봅니다.",
    howTitle: "이렇게 진행돼요",
    feeTitle: "비용은 이것뿐",
    feeRows: [["상품 가격", "원본 마켓 판매가를 환율 적용"], ["국제 배송비", "주문당 1회, 무게·부피로 미리 예측"], ["통관·관세", "관세·세금·통관·보험 일체. 면세 한도 이하 10%, 초과 시 세금 + 5%"]],
    feeNote: "주문 시 1회 결제, 받으실 때 추가 청구 없음. 환율은 결제 시점 기준.",
    trustTitle: "안전장치",
  ...
  ja: {
    ...
    lead: "TOMOは韓国と日本のフリマを一か所で見て、1回の決済で自宅まで届くサービスです。メルカリ・Yahoo!フリマ・タングン・中古ナラの商品を自分の言語・通貨で。",
    howTitle: "流れ",
    feeTitle: "費用はこれだけ",
    feeRows: [["商品価格", "元マーケットの価格に為替を適用"], ["国際配送費", "注文ごとに1回、重量・サイズで事前見積もり"], ["通関・関税", "関税・税金・通関・保険一式。免税枠内は10%、超過時は税金 + 5%"]],
    feeNote: "注文時に1回のみ決済、お受け取り時の追加請求なし。為替は決済時点のレート。",
    trustTitle: "安心機能",
