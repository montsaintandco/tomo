...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const statics: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/global`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
    { url: `${SITE_URL}/guide`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/travel`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${SITE_URL}/categories`, lastModified: now, changeFrequency: "weekly", priority: 0.5 },
    { url: `${SITE_URL}/about`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    { url: `${SITE_URL}/help`, lastModified: now, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/notice`, lastModified: now, changeFrequency: "weekly", priority: 0.3 },
    ...
    { url: `${SITE_URL}/refund`, lastModified: now, changeFrequency: "yearly", priority: 0.1 },
  ];
